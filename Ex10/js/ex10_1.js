...
operador = arrayOperadores[Math.floor(Math.random()*arrayOperadores.length)];


//1.4
document.getElementById('op').value = operador
...
if (resultadoUtilizador != '') {
  if (resultadoVerdadeiro == resultadoUtilizador) {
    correto = true
  } else {
    correto = false
  }
