...
var resultadoVerdadeiro , resultadoUtilizador, correto, metade;
/* OUTRA MANEIRA DE FAZER (versão1)
...
*/
if (operador2 == "x" || operador2 == "/" ) { //caso aconteça o operador2 tem prioridade
  ...
  if (operador1 == "/") {
...
} else if (operador1 == "x" || operador1 =="/") { //caso o operador2 não tenha prioridade, o operador1 tem prioridade
    ...
    if (operador2 == "+") {
      resultadoVerdadeiro = metade + n3
    }
    if (operador2 == "-") {
      resultadoVerdadeiro = metade - n3
    }
} else {  //caso nenhum tenha prioridade
  if (operador1 == "+" && operador2 == "+") {
    resultadoVerdadeiro = n1 + n2 + n3
  }
  if (operador1 == "+" && operador2 == "-") {
